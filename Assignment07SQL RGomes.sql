...
-- 2017-01-01,RGomes,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_RGomes')
	 Begin 
	  Alter Database [Assignment07DB_RGomes] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_RGomes;
	 End
	Create Database Assignment07DB_RGomes;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_RGomes;
